...
<body>
 ...
 <form action="../php/exercicio05.php" method="post">
    <fieldset>
        ...
        <input type="date" name="data" min="2017-12-02" max="2024-12-25"> <br>
    ...
    <fieldset>
        ...
        <input type="date" name="alterar-data" min="2017-12-02" max="2024-12-25">
    ...
    if(isset($_POST['alterar'])){
        $livro->alterarData($conexao, $banco->nomeDaTabela);
        echo "<p>livro cadastrado com sucesso no banco de dados. </p>";
    }
    if(isset($_POST['outras-oepracoes'])){
        $operacao = $_POST['operacao'];
        if($operacao == "1"){
            $livro->excluirLivros($conexao, $banco->nomeDaTabela);
        }
        if($operacao == "2"){
            $livro->tabularDados($conexao, $banco->nomeDaTabela);
        }

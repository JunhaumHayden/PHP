...
<body>
    <div class="welcome-container">
        <h1 class="welcome-title">Bem-vindo(a), <?php echo $_SESSION['aluno']; ?>.</h1>
        <h3 class="welcome-title">Sua média é: <?php echo $_SESSION['media']; ?>.</h3>
        <p class="welcome-subtitle">Explore nosso site e sinta-se em casa. Que sua experiência seja leve e agradável.</p>
        <p class="welcome-subtitle">Ultimo acesso em: <?php echo $_SESSION['data']; ?>.</p>
